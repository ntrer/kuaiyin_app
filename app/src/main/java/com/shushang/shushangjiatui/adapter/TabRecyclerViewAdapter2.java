...
public class TabRecyclerViewAdapter2 extends BaseQuickAdapter<String,BaseViewHolder> {
    ...
    public TabRecyclerViewAdapter2(@LayoutRes int layoutResId, @Nullable List<String> data) {
