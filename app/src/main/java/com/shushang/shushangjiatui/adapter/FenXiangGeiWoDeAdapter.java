...
public class FenXiangGeiWoDeAdapter extends BaseQuickAdapter<JIaDou.DataBean.CustomerFollowUpListBean,BaseViewHolder> {


    public FenXiangGeiWoDeAdapter(int layoutResId, @Nullable List<JIaDou.DataBean.CustomerFollowUpListBean> data) {
